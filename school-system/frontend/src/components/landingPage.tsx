...
const LandingPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const interactiveElements = document.querySelectorAll(
      "a, button, .feat-card, .testi-card, .price-card",
    );
  ...
  const switchRole = (role: string) => {
    ...
    setTimeout(() => {
      ...
      if (newContent) {
        const reveals = newContent.querySelectorAll(
    ...
    <div className={styles.app}>
      ...
      <nav className={`${styles.nav} ${scrolled ? styles.scrolled : ""}`}>
        <a href="#" className={styles.navLogo}>
          ...
          <div className={styles.navLogoText}>
            <span className={styles.navLogoName}>Edunex</span>
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.heroSub}>
              Edunex brings class management, marks entry, parent communication,
              and leadership oversight into one elegant system — built for how
            ...
            <div className={styles.heroTrust}>
              ...
              <p className={styles.heroTrustText}>
                Trusted by <strong>240+ schools</strong> across Kenya
              </p>
            </div>
          </div>
              ...
              <div className={styles.heroCardBody}>
                <div className={styles.heroMetricRow}>
                  ...
                  <div className={styles.heroMetric}>
                    ...
                    <div
                      className={`${styles.heroMetricVal} ${styles.goldText}`}
                    >
                      76%
                    </div>
                  ...
                  <div className={styles.heroMetric}>
                    ...
                    <div
                      className={`${styles.heroMetricVal} ${styles.greenText}`}
                    >
                      85%
                    </div>
                ...
                <div>
                  <div className={styles.heroTableRow}>
                    ...
                    <span className={`${styles.heroRowTag} ${styles.tagGreen}`}>
                      A · 88%
                    </span>
                  </div>
                  <div className={styles.heroTableRow}>
                    ...
                    <span className={`${styles.heroRowTag} ${styles.tagGold}`}>
                      B · 77%
                    </span>
                  </div>
                  <div className={styles.heroTableRow}>
      ...
      >
        <div className={styles.sectionInner}>
          <div
            className={`${styles.reveal} ${styles.textCenter}`}
          ...
          >
            ...
            <h2 className={styles.sectionTitle}>
              Every tool your school <em>needs.</em>
            </h2>
            <p className={styles.sectionSub} style={{ margin: "16px auto 0" }}>
              From the head teacher's office to every classroom — one platform
              that keeps everyone aligned without the chaos.
            </p>
          </div>
          <div className={styles.featuresGrid}>
            ...
            >
              ...
              <p className={styles.featDesc}>
                Assign class teachers to streams, manage student rosters, and
                track attendance — all from one clean interface that updates in
                real time.
              </p>
              <a href="#" className={styles.featLink}>
                Explore feature{" "}
                <svg
                  width="12"
                  height="12"
            ...
            >
              ...
              <p className={styles.featDesc}>
                Subject teachers enter marks directly, class teachers review and
                approve, and reports are generated automatically — no
                spreadsheets needed.
              </p>
              <a href="#" className={styles.featLink}>
                Explore feature{" "}
            ...
            >
              ...
              <p className={styles.featDesc}>
                Track class averages, subject performance, and student progress
                with visual dashboards that surface the insights you actually
                need for decisions.
              </p>
              <a href="#" className={styles.featLink}>
                Explore feature{" "}
            ...
            >
              ...
              <p className={styles.featDesc}>
                Log parent concerns, track response timelines, and maintain a
                clean record of every family interaction — so nothing falls
                through the cracks.
              </p>
              <a href="#" className={styles.featLink}>
                Explore feature{" "}
            ...
            >
              ...
              <p className={styles.featDesc}>
                Generate individual result slips, class summaries, and
                leadership packs in PDF or Excel — ready to print or send in
                seconds, not hours.
              </p>
              <a href="#" className={styles.featLink}>
                Explore feature{" "}
            ...
            >
              ...
              <p className={styles.featDesc}>
                Super admin, admin, head teacher, deputy, class teacher, and
                subject teacher — each role sees exactly what they need and
                nothing they don't.
              </p>
              <a href="#" className={styles.featLink}>
                Explore feature{" "}
      ...
      {/* Roles Section */}
      <section
        className={`${styles.section} ${styles.rolesSection}`}
        id="roles"
      >
        <svg
          className={styles.rolesSectionGrid}
        ...
        <div className={styles.sectionInner}>
          <div className={`${styles.reveal} ${styles.rolesHeader}`}>
            ...
            <h2 className={styles.sectionTitle}>
              Built for <em>every role</em> in your school.
            </h2>
            <p className={styles.sectionSub}>
              Six distinct dashboards, each fine-tuned to what that person
              actually does every day.
            </p>
          </div>
          <div className={`${styles.reveal} ${styles.rolesTabs}`}>
            <button
              className={`${styles.roleTab} ${activeRole === "admin" ? styles.active : ""}`}
              onClick={() => switchRole("admin")}
            >
              Admin
            </button>
            <button
              className={`${styles.roleTab} ${activeRole === "head" ? styles.active : ""}`}
              onClick={() => switchRole("head")}
            >
              Head Teacher
            </button>
            <button
              className={`${styles.roleTab} ${activeRole === "deputy" ? styles.active : ""}`}
              onClick={() => switchRole("deputy")}
            >
              Deputy Head
            </button>
            <button
              className={`${styles.roleTab} ${activeRole === "class" ? styles.active : ""}`}
              onClick={() => switchRole("class")}
            >
              Class Teacher
            </button>
            <button
              className={`${styles.roleTab} ${activeRole === "subject" ? styles.active : ""}`}
              onClick={() => switchRole("subject")}
            >
              Subject Teacher
            </button>
          </div>
          ...
          {/* Admin Role */}
          <div
            className={`${styles.roleContent} ${activeRole === "admin" ? styles.active : ""}`}
            id="role-admin"
          >
            <div className={styles.revealLeft}>
              <div className={styles.roleInfoTag}>
                <span>Administrator</span>
              </div>
              <h3 className={styles.roleTitle}>
                Total control over school structure.
              </h3>
              <p className={styles.roleDesc}>
                The admin sets up and maintains the school's entire
                configuration — from adding classes and subjects to assigning
                every teacher to their rightful place.
              </p>
              <div className={styles.rolePerms}>
                {[
                  "Add, edit, and remove classes and streams",
                  "Assign class teachers and subject teachers",
                  "Manage the full teacher directory",
                  "Register and configure all school subjects",
                ].map((perm, i) => (
              ...
              <div className={styles.roleVisual}>
                <div className={styles.roleUiCard}>
                  <div className={styles.roleUiHeader}>
                    ...
                    <span className={styles.roleUiTitle}>
                  ...
                  <div className={styles.roleUiBody}>
                    <div className={styles.adminMetrics}>
                      <div className={styles.adminMetric}>
                        <p>Classes</p>
                        <p className={styles.adminMetricValue}>6</p>
                      </div>
                      <div className={styles.adminMetric}>
                        <p>Subjects</p>
                        <p className={styles.adminMetricValue}>8</p>
                      </div>
                      <div className={styles.adminMetric}>
                        <p>Staff</p>
                        <p className={styles.adminMetricValue}>8</p>
                    ...
                    <div className={styles.classRoster}>
                      ...
                      <div className={styles.classRosterItem}>
                        <div
                          className={styles.classRosterAvatar}
                          style={{ background: "#1D9E75" }}
                        >
                          PE
                        </div>
          ...
          {/* Head Teacher Role */}
          <div
            className={`${styles.roleContent} ${activeRole === "head" ? styles.active : ""}`}
            id="role-head"
          >
            <div className={styles.revealLeft}>
              <div className={styles.roleInfoTag}>
              ...
              <h3 className={styles.roleTitle}>
                Whole-school leadership at a glance.
              </h3>
              <p className={styles.roleDesc}>
                The head teacher sees the full operational picture — staff,
                learners, analytics, and reports — without getting lost in the
                day-to-day minutiae.
              </p>
              <div className={styles.rolePerms}>
                {[
                  "Full school performance dashboard",
                  "Access to leadership reports and summaries",
                  "Staff management and oversight",
                  "Parent concern management and follow-up",
                ].map((perm, i) => (
                  <div key={i} className={styles.rolePerm}>
                    <div className={styles.rolePermIcon}>
                      <svg
                ...
                <div className={styles.roleUiCard}>
                  ...
                  <div className={styles.roleUiBody}>
                    ...
                    <div className={styles.statsRow}>
                      ...
                      <div className={styles.statsBoxRed}>
                        <p>2</p>
                        <p>Open concerns</p>
                      </div>
                    </div>
          ...
          {/* Deputy Role */}
          <div
            className={`${styles.roleContent} ${activeRole === "deputy" ? styles.active : ""}`}
            id="role-deputy"
          >
            <div className={styles.revealLeft}>
              <div className={styles.roleInfoTag}>
                <span>Deputy Head Teacher</span>
              </div>
              <h3 className={styles.roleTitle}>
                Academic support without the noise.
              </h3>
              <p className={styles.roleDesc}>
                The deputy focuses on academic coordination — tracking class
                performance, supporting teachers, and managing parent
                interactions across the school.
              </p>
              <div className={styles.rolePerms}>
                {[
                  "Class and student management view",
                  "Analytics across all streams",
                  "Parent concern tracking and response",
              ...
              <div className={styles.roleVisual}>
                <div className={styles.roleUiCard}>
                  <div className={styles.roleUiHeader}>
                    ...
                    <span className={styles.roleUiTitle}>
                      Leadership Hub · Parent Concerns
                    </span>
                  </div>
                  <div className={styles.roleUiBody}>
                    {[
                      [
                        "Mr. John Mwangi",
                        "Emma Mwangi · Grade 7A",
                        "Grade review requested",
                        "High",
                        "Open",
                      ],
                      [
                        "Mrs. N. Njeri",
                        "Cynthia Achieng · Grade 9A",
                        "Counselling support request",
                        "High",
                        "Pending",
                      ],
                      [
                        "Mr. K. Kimutai",
                        "Brian Kipchoge · Grade 8B",
                      ...
                      <div key={idx} className={styles.concernCard}>
                        <div className={styles.concernHeader}>
                          ...
                          <div className={styles.concernBadges}>
                            <span
                              className={`${styles.badgeRed} ${styles.badgePill}`}
                            >
                              {pr}
                            </span>
                            <span
          ...
          {/* Class Teacher Role */}
          <div
            className={`${styles.roleContent} ${activeRole === "class" ? styles.active : ""}`}
            id="role-class"
          >
            <div className={styles.revealLeft}>
              <div className={styles.roleInfoTag}>
              ...
              <h3 className={styles.roleTitle}>
                Everything your stream needs, in one place.
              </h3>
              <p className={styles.roleDesc}>
                The class teacher manages their assigned stream end-to-end —
                student records, marks review, result downloads, and class-level
                performance tracking.
              </p>
              <div className={styles.rolePerms}>
                {[
                  "Full student roster and profile management",
                  "Review and approve marks from subject teachers",
                  "Download result slips and class reports",
              ...
              <div className={styles.roleVisual}>
                <div className={styles.roleUiCard}>
                  <div className={styles.roleUiHeader}>
                    ...
                    <span className={styles.roleUiTitle}>
                      Class Teacher Hub · Student Records
                    </span>
                  </div>
                  <div className={styles.roleUiBody}>
                    {[
                    ...
                    <div className={styles.classStatsRow}>
                      ...
                      <div className={styles.classStatGold}>
                        <p>85%</p>
                        <p>Readiness</p>
                      </div>
                    </div>
          ...
          <div
            className={`${styles.roleContent} ${activeRole === "subject" ? styles.active : ""}`}
            id="role-subject"
          >
            <div className={styles.revealLeft}>
              <div className={styles.roleInfoTag}>
              ...
              <p className={styles.roleDesc}>
                Subject teachers enter marks for their assigned classes, track
                student progress per subject, and push results directly to the
                class teacher for review.
              </p>
              <div className={styles.rolePerms}>
                {[
                  "View all assigned subjects and classes",
                  "Enter and edit student marks per class",
                  "Push marks to class teacher for approval",
              ...
              <div className={styles.roleVisual}>
                <div className={styles.roleUiCard}>
                  ...
                  <div className={styles.roleUiBody}>
                      ...
                      {[
                        ...
                        <div key={c} className={styles.subjectClassCard}>
                          ...
                          <div className={styles.subjectClassFooter}>
                            <span>{s}</span>
                            <button className={styles.enterMarksBtn}>
                              Enter marks
                            </button>
                          </div>
                        </div>
                    ...
                    <button className={styles.pushMarksBtn}>
                      Push marks to class teacher
                    </button>
                  </div>
                </div>
              </div>
      ...
      <section className={`${styles.section} ${styles.statsSection}`}>
        ...
        <div className={styles.sectionInner}>
          <div className={`${styles.reveal} ${styles.textCenter}`}>
            ...
            <h2 className={styles.sectionTitle}>
              Real results across <em>real schools.</em>
            </h2>
          </div>
      ...
      <section className={`${styles.section} ${styles.howSection}`} id="how">
        <div className={styles.sectionInner}>
          <div className={`${styles.reveal} ${styles.textCenter}`}>
            ...
            <p className={styles.sectionSub} style={{ margin: "16px auto 0" }}>
              No lengthy onboarding. No IT department required. Your school is
          ...
          <div className={styles.howSteps}>
            ...
            >
              ...
              <p className={styles.howStepDesc}>
                An admin adds your classes, subjects, and teacher directory.
                Assign class teachers and subject teachers to each stream in
                minutes.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className={styles.howStepDesc}>
                Each person logs in to their own tailored dashboard. Head
                teacher, deputy, class teacher, subject teacher — everyone sees
            ...
            >
              ...
              <p className={styles.howStepDesc}>
                Subject teachers enter marks, class teachers review and approve,
                and leadership downloads reports — all without a single
                spreadsheet or paper form.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={`${styles.section} ${styles.testimonialsSection}`}>
        <div className={styles.sectionInner}>
          <div className={`${styles.reveal} ${styles.textCenter}`}>
            ...
            <h2 className={styles.sectionTitle}>
              Trusted by educators <em>who know.</em>
            </h2>
            <p className={styles.sectionSub} style={{ margin: "16px auto 0" }}>
              Real feedback from head teachers, class teachers, and deputies who
              use Edunex every term.
            </p>
          </div>
          <div className={styles.testimonialsGrid}>
              ...
              <div className={styles.testiAuthor}>
                ...
                <div>
                  ...
                  <div className={styles.testiRole}>
                    Head Teacher, Starehe Girls Centre, Nairobi
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className={styles.testiStars}>★★★★★</div>
              <div className={styles.testiQuote}>
                As a deputy, I was always chasing teachers for marks. Now
                everything flows automatically from subject teacher to class
                teacher to my overview. The parent concern tracker alone is
                worth it.
              </div>
              <div className={styles.testiAuthor}>
                <div
                ...
                <div>
                  ...
                  <div className={styles.testiRole}>
                    Deputy Head, Alliance High School, Kikuyu
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className={styles.testiStars}>★★★★★</div>
              <div className={styles.testiQuote}>
                I teach Mathematics across four streams. Being able to enter
                marks for each class, see performance per stream, and push
                everything to the class teacher — all from my phone — is
                remarkable.
              </div>
              <div className={styles.testiAuthor}>
                <div
                ...
                <div>
                  ...
                  <div className={styles.testiRole}>
                    Subject Teacher, Kisumu Boys High School
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        <div className={styles.sectionInner}>
          <div className={`${styles.reveal} ${styles.textCenter}`}>
            ...
            <h2 className={styles.sectionTitle}>
              One price. <em>Whole school.</em>
            </h2>
            <p className={styles.sectionSub} style={{ margin: "16px auto 0" }}>
              No per-user fees, no hidden charges. Pick the plan that fits your
              school's size and get everyone onboarded in a day.
            </p>
          </div>
          <div className={styles.pricingGrid}>
            <div
              className={`${styles.priceCard} ${styles.starter} ${styles.reveal}`}
              style={{ transitionDelay: "0.05s" }}
            >
              <div className={`${styles.priceBadge} ${styles.starterB}`}>
                Starter
              </div>
              <div className={styles.priceName}>Foundation</div>
              <div className={styles.priceDesc}>
                For smaller schools getting started with digital management.
              </div>
            ...
            <div
              className={`${styles.priceCard} ${styles.pro} ${styles.reveal}`}
              style={{ transitionDelay: "0.1s" }}
            >
              <div className={`${styles.priceBadge} ${styles.popular}`}>
                Most popular
              </div>
              <div className={styles.priceName}>Professional</div>
              <div className={styles.priceDesc}>
                For growing schools that need the full leadership suite.
              </div>
              <div className={styles.priceAmount}>
                <span className={styles.priceCurrency}>KES</span>
              ...
              <div className={styles.priceFeatures}>
                {[
                  ...
                  "Analytics & leadership reports",
                  "Parent concerns module",
            ...
            <div
              className={`${styles.priceCard} ${styles.enterprise} ${styles.reveal}`}
              style={{ transitionDelay: "0.15s" }}
            >
              <div className={`${styles.priceBadge} ${styles.enterpriseB}`}>
                Enterprise
              </div>
              <div className={styles.priceName}>Institution</div>
              <div className={styles.priceDesc}>
                For large schools, multi-campus institutions, and county
                offices.
              </div>
              <div className={styles.priceAmount}>
                <span className={styles.priceCurrency}>KES</span>
              ...
              <a href="#" className={`${styles.priceBtn} ${styles.greenBtn}`}>
                Contact us
              </a>
            </div>
          </div>
        ...
        <div className={styles.ctaInner}>
          <div className={`${styles.ctaCard} ${styles.revealScale}`}>
            ...
            <div className={styles.ctaActions}>
              ...
              <a
                href="#"
                className={`${styles.btnSecondary} ${styles.ctaSecondary}`}
              >
                Book a demo call
              </a>
            </div>
        ...
        <div className={styles.footerInner}>
          <div className={styles.footerTop}>
            <div className={styles.footerBrand}>
              <div className={styles.footerBrandLogo}>
                ...
                <span className={styles.footerBrandName}>Edunex</span>
              </div>
              <p className={styles.footerBrandDesc}>
                The complete school management system built for Kenyan schools —
                from classroom to leadership office.
              </p>
              <div className={styles.footerContact}>
                ...
                <p>
                  <strong>Email:</strong> carlosmaina198@gmail.com
                </p>
                <p>
                  <strong>Support:</strong> softwarewebdevelopers1@gmail.com
                </p>
              </div>
            </div>
            <div>
          ...
          <div className={styles.footerBottom}>
            <span className={styles.footerCopy}>
              {`@ ${new Date().getFullYear()} Edunex. Built with care for Kenyan schools by Carloz
              Technologies.`}
            </span>
