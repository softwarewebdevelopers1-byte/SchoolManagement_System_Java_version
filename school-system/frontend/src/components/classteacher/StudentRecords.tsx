...
export const StudentRecords: React.FC<StudentRecordsProps> = ({
  ...
  const filtered = students.filter(
    (s) =>
      String(s.name || s.studentFullName || "").toLowerCase().includes(search.toLowerCase()) ||
            ...
            {filtered.map((s) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ padding: "12px 14px", fontFamily: FONT.sans, fontSize: 12.5, color: C.textMuted }}>
                    {s.email || "-"}
                  </td>
                  <td style={{ padding: "12px 14px", fontFamily: FONT.sans, fontSize: 12.5, color: C.textMuted }}>
