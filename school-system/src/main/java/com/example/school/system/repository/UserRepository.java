...
public interface UserRepository extends JpaRepository<Users, UUID> {
    ...
    @Query("""
             SELECT u.id as userId, u.email as email,u.status as status,sp.studentFullName as fullName, sp.studentAdm as adm, sp.gender as gender,sp.phoneNumber as phoneNumber,sp.guardianName as guardianName, c.classGrade as classGrade, c.classStream as classStream, subjects as enrolledSubjects
            FROM Users u
            LEFT JOIN u.studentProfile sp
            LEFT JOIN sp.schoolClass c
            LEFT JOIN sp.studentSubjectSelections as subjects
