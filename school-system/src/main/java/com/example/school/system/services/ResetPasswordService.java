...
//         LoginView user = userRepository.findByEmail(resetPasswordDto.email()).orElseThrow();
...
//     private ExpiryLinks toToken(String token, LoginView user) {
//         var newLink = new ExpiryLinks();
//         newLink.setToken(token);
//         newLink.setUsers(user.getUserId());
//         return newLink;
//     }
...
//         validationTken.append(jwtCreationService.GenerateToken((LoginView) userFound));
